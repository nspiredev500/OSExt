...
bool k_streq_len(const char *s1, const char *s2, uint32_t max); // doesn't check if the lengths are equal, so it's true if one string is the starting part of the other
